...
Partial implementation of the {Aeronautical Information Exchange Model (AIXM)}[http://aixm.aero]
for Ruby.

For now, only the parts needed to automize the AIP import of {Open Flightmaps}[https://openflightmaps.org]
are part of this gem. Feel free to submit pull requests implementing further
bits of AIXM.
